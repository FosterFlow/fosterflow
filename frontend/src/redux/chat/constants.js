...
export const WS_MESSAGE_SEND_INIT_STATE = "WS_MESSAGE_SEND_INIT_STATE";
export const WS_MESSAGE_SEND_SUCCCESS = "WS_MESSAGE_SEND_SUCCCESS";
export const WS_MESSAGE_SEND_FAILED = "WS_MESSAGE_SEND_FAILED";
