...
def create_Gpt35Turbo4K(apps, schema_editor):
    ai_model = NlpModel.objects.create(title='GPT-3.5-turbo-4k')
    ai_model.save()
...
def create_Gpt35Turbo16K(apps, schema_editor):
    ai_model = NlpModel.objects.create(title='GPT-3.5-turbo-16k')
    ai_model.save()
...
def create_Gpt48K(apps, schema_editor):
    ai_model = NlpModel.objects.create(title='GPT-4-8k')
    ai_model.save()
...
def create_Gpt432K(apps, schema_editor):
    ai_model = NlpModel.objects.create(title='GPT-4-32k')
    ai_model.save()
